...
public class DataInitializer {
  ...
  CommandLineRunner initSampleData(
    ...
    return args -> {
      try {
        ...
        initSampleReport(reportRepository);
  ...
  private List<Menu> createMenuList() {
    ...
    menus
        .add(createMenu("Cappuccino", "Espresso with steamed milk and foam", "39,45,52", SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    ...
    menus
        .add(createMenu("Americano", "Espresso diluted with hot water", COST_30_35_40, SIZE_M_L_XL, MenuStatus.ACTIVE));
    menus.add(createMenu("Mocha", "Espresso with chocolate and milk", COST_35_40_45, SIZE_M_L_XL, MenuStatus.ACTIVE));
    menus
        .add(createMenu("Caramel Macchiato", "Espresso with caramel and milk", "42,48,55", SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    menus.add(createMenu("Black Coffee", "Strong black brewed coffee", COST_25_30_35, SIZE_S_M_L, MenuStatus.ACTIVE));
    menus
        .add(createMenu("Hazelnut Coffee", "Coffee with hazelnut flavor", COST_35_40_45, SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    ...
    menus.add(createMenu("Milk Tea with Pearls", "Classic milk tea with tapioca pearls", COST_35_40_45, SIZE_M_L_XL,
        MenuStatus.ACTIVE));
    menus
        .add(createMenu("Avocado Smoothie", "Fresh avocado blended with milk", "40,45,50", SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    menus
        .add(createMenu("Mango Smoothie", "Smooth mango drink with milk", COST_35_40_45, SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    menus.add(
        createMenu("Orange Juice", "Freshly squeezed orange juice", COST_30_35_40, SIZE_M_L_XL, MenuStatus.ACTIVE));
    menus
        .add(createMenu("Iced Chocolate", "Chocolate drink topped with cream", "45,50,55", SIZE_M_L_XL,
            MenuStatus.ACTIVE));
    menus
        .add(createMenu("Cookies & Cream Frappe", "Blended cookies and milk", "45,50,55", SIZE_M_L_XL,
            MenuStatus.ACTIVE));
  ...
  private Report initSampleReport(ReportRepository reportRepository) {
    Report report = new Report();
    report.setReportDate(LocalDate.now());
    report.setTotalOrders(100);
    report.setTotalRevenue(BigDecimal.valueOf(1000));
    report.setTotalCustomer(100);
